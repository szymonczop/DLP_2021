...
parser.add_argument("--model", default="cnn", help="Model architecture", type=str, required=True,
...
if args.params is None:
    ...
    history = model_dict[args.model].fit(
        train_generator, epochs=args.num_epochs, validation_data=test_generator,
        verbose=1, callbacks=[early_stopping, tensorboard, reduce_lr, model_checkpoint]
    )
else:
    ...
    history = model_dict[args.model].fit(
        train_generator, epochs=model_params["num_epochs"], validation_data=test_generator,
